...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var btnStart = document.querySelector('#ico .main__right-colum .main__movie-btn');
  var btnStop = document.querySelector('#mVideo .close');
  var videoEl = document.querySelector('#mVideo .video');
  ...
  btnStop.addEventListener('click', function () {
    var videoMove = document.querySelector('#mVideo .video video ');
